...
from .main import bcrypt_context,SECRET_KEY,ALGORITMH,ACCESS_TOKEN_EXPIRE_MINUTES #importando as variaveis de criptografia e token do main
...
from fastapi.security import OAuth2Re #usado pra definir o esquema de autenticacao do tipo oauth2 com senha e bearer token
...
clientes_auth_router = APIRouter(prefix='/clientes_auth',tags=['Clientes_Auth'],dependencies = Depends(verificar_token)) #criando o roteador de clientes, com prefixo e tag
